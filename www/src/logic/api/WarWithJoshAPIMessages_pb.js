...
goog.exportSymbol('proto.web.EndSessionMessage', null, global);
 ...
 * @constructor
 */
proto.web.EndSessionMessage = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.web.EndSessionMessage, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.web.EndSessionMessage.displayName = 'proto.web.EndSessionMessage';
}
 ...
 * @return {!Object}
 */
proto.web.EndSessionMessage.prototype.toObject = function(opt_includeInstance) {
  return proto.web.EndSessionMessage.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.web.EndSessionMessage} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.web.EndSessionMessage.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.web.EndSessionMessage}
 */
proto.web.EndSessionMessage.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.web.EndSessionMessage;
  return proto.web.EndSessionMessage.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.web.EndSessionMessage} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.web.EndSessionMessage}
 */
proto.web.EndSessionMessage.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.web.EndSessionMessage.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.web.EndSessionMessage.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.web.EndSessionMessage} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.web.EndSessionMessage.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
